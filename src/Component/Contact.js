                ...
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex items-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-gray-500">+231-698-9945</p>
                      <p class="text-gray-500">+231-596-1385</p>
                    </div>
                  </div>
                </div>
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex items-start">
                    ...
                    <div class="grow ml-6">
                      <p class="font-bold mb-1">Information</p>
                      <p class="text-gray-500">rashiegarleyjr11@gmail.com</p>
                      <p class="text-gray-500">+231-7761-38422</p>
                    </div>
                  </div>
                </div>
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      ...
                      <p class="text-gray-500">ijosekpadeh@gmail.com</p>
                      <p class="text-gray-500">pewuzonic@gmail.com</p>
                    </div>
                  </div>
                </div>
                <div class="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                  <div class="flex align-start">
                    ...
                    <div class="grow ml-6">
                      <p class="font-bold mb-1">Report Issue @</p>
                      <p class="text-gray-500">+231-0244-025</p>
